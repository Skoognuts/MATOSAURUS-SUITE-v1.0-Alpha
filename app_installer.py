...
class Window(QtWidgets.QWidget):
    ...
    def windowUI(self):
        ...
        self.lbl_desc_1 = QtWidgets.QLabel("Vous êtes sur le point d'installer la suite MATOSAURUS sur votre ordinateur.")
        self.lbl_desc_2 = QtWidgets.QLabel("Avant de démarrer l'installation, il est recommandé de fermer toutes les \nautres applications. Cela permettra la mise à jour de certains fichiers système \nsans redémarrer votre ordinateur.")
        ...
        self.btn_continue = QtWidgets.QPushButton("Suivant  >", self)
        ...
        self.grid_layout.addWidget(self.btn_continue, 5, 4, 1, 1)
